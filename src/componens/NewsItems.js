            ...
            <>
                <div className="card my-2">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text"><small className="text-body-danger text-danger">by <strong>{author ? author : 'Unknown'}</strong> on <strong>Date</strong>: {new Date(date).toDateString()} </small></p>
